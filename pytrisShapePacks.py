class ShapePack:
    def __init__(self, name, shapes, colors):
        self.name = name
        self.shapes = shapes
...
srs_shape_colors = [(0, 255, 0), (255, 0, 0), (0, 255, 255), (255, 255, 0), (0, 0, 255), (255, 165, 0), (128, 0, 128)]
...
triomino_colors = [(0, 255, 255), (128, 0, 128)]

all_shapes = [srs_S, srs_Z, srs_I, srs_O, srs_J, srs_L, srs_T, monomino, domino, triomino_I, triomino_V]
all_colors = [(0, 255, 0), (255, 0, 0), (0, 255, 255), (255, 255, 0), (0, 0, 255), (255, 165, 0), (128, 0, 128), (0, 255, 255), (255, 0, 0), (0, 255, 255), (128, 0, 128)]

SRS_PACK = ShapePack("SRS", srs_shapes, srs_shape_colors)
MONOMINO_PACK = ShapePack("Monominos", monomino_shapes, monomino_colors)
DOMINO_PACK = ShapePack("Dominos", domino_shapes, domino_colors)
TRIOMINO_PACK = ShapePack("Triominos", triomino_shapes, triomino_colors)
EVERYTHING_PACK = ShapePack("Everything", all_shapes, all_colors)
